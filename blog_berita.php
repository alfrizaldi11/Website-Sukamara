            ...
            <div class="row">
                <div class="col-lg-8 mb-5 mb-lg-0">
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                ...
                                <a class="blog_item_date">
                                    <h3><?php echo date('M d, Y', strtotime ($data['tanggal_berita'])); ?></h3>
                                </a>
                            </div>
                    ...
                    <ul class="pagination">
                            ...
                            ?>
                                <li class="page-item"><a class="page-link" href="blog_berita.php?page=1">First</a></li>
                                <li class="page-item"><a class="page-link" href="blog_berita.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                            <?php
                            }
                            ?>
                            ...
                            ?>
                                <li class="page-item" <?php echo $link_active; ?>><a class="page-link" href="blog_berita.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                            <?php
                            }
                            ?>
                            ...
                            ?>
                                <li class="page-item"><a class="page-link" href="blog_berita.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                                <li class="page-item"><a class="page-link" href="blog_berita.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                            <?php
                            }
                            ?>
                    </ul>
