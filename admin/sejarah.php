      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card-header py-3">
              <h4 class="font-weight-bold text-primary">Sejarah</h4>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="card-body">
            ...
            <?php
                $edit=mysqli_query($koneksi,"SELECT * from sejarah");
                $hasil = mysqli_fetch_array($edit);
                
                $isi_sejarah = $hasil['isi_sejarah'];
              ?>

            <form role="form" action="aksi_edit_sejarah.php" method="POST">
              <div class="box-body">
...
?>
  ...
  <script>CKEDITOR.replace( 'isi_sejarah' );</script>
